    ...
    return(
        <div className="navbar">
           ...
           <ul className="nav-links">
                ...
                <li>
                    <Link to="/guest/events/?cat=gym">Events</Link>
                </li>
                <li>
                    <Link to="/guest/shop">Shop</Link>
                </li>
                <li>
                 ...
                 {menuOpen && (
                        <div className="dropdown">
                            ...
                            <Link to='/home' onClick={closeMenu}><li className="d"><FaHome/><span className="user">Home</span></li></Link>
                                ...
                                <Link to="/guest/events/?cat=gym" onClick={closeMenu}><li className="d"><FaEvernote/><span className="user">Events</span></li></Link>
                                <Link to="/guest/shop" onClick={closeMenu}><li className="d"><FaShopify/><span className="user">Shop</span></li></Link>
